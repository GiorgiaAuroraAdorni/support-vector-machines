...
In this case it is necessary to retrain the SVM to find another hyperplanes the 
correctly classified this data-point.}\vspace{.4cm}
...
taking into consideration the new training sample collected. The model is not 
influence by non-support-vector data-points.}\vspace{.4cm}
