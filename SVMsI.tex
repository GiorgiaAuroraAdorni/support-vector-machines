...
\Solution{Since we are in a 3D space, the decision boundary 
should be a 2D hyper-plane.}\vspace{.4cm}
...
expansion, for example mapping them in a n-dimensional space where n is the 
